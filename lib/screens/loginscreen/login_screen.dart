      ...
      body: Form(
        ...
        child: ListView(
          children: <Widget>[
            ...
            CustomTextButton(
                text: AppStringManager.forgotPassword, onpressed: () {}, textstyle: AppTextStyleManager.bold12),
            Container(
              height: 70.h,
                ...
                listener: (context, state) async {
                  if (state is LoginBlocLoading) {
                    ...
                    var settoken = await CacheHelper.saveData(
                        "logintoken", state.loginData.message?.token);
                  ...
                  }else if (state is LoginBlocMessage){
        //               var snackBar = SnackBar(content: Text('${state.loginDataMessage.message}'));
